...
function App() {
  ...
  const handleGenerateTestCases = () => {
    ...
    for (let column of columns) {
      const { test_case, expected_result, test_steps } = testOptions[
        testOption
      ](column, tableName);
      const actual_result = "";
  ...
  const handleDownloadCSV = () => {
    ...
    testCases.forEach((testCase, index) => {
      ...
      const quotedValues = testCase.map(
        ...
        <div className="input-container">
          <div class="parent-container">
            <div className="input-field">
              ...
              <div className="input-field">
                <label htmlFor="column-names">
                  Enter column names or paste from spreadsheet{" "}
                </label>
                <input
                  id="column-names"
                  type="text"
            ...
            <thead>
              <tr>
                ...
                <th className="no-wrap">
                  Actual result (Not As Expected/As Expected)
                </th>
                <th>Status</th>
              </tr>
            </thead>
